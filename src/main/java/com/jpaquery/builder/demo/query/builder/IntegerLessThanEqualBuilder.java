...
@Slf4j
@Service
public class IntegerLessThanEqualBuilder<T> implements QueryBuilder<T> {
    ...
    public Predicate buildPredicate(CriteriaBuilder builder, Root<T> root, String key, Object value, String entity) {
        return builder.lessThanOrEqualTo(getObject(root, entity, key), Integer.parseInt(value.toString()));
    }
}
